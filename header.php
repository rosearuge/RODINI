<nav class="navbar sticky-top"  style="background-color: #CFCFB1">
  ...
  <a href="index.php"><button type="button" class="btn btn-default navbar-btn">HOME</button></a>
  <a href="preguntas.php"><button type="button" class="btn btn-default navbar-btn">FAQ</button></a>
